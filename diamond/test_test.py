...
input_path = os.path.join(base_input_path, current_timestamp + '/')
output_path = os.path.join(base_output_path, current_timestamp + '/')
log_path = os.path.join(base_log_path, current_timestamp + '/')
...
def generate_test_examples():
    for i in range(0, num_graphs):
        print(f"Generating {i+1} / {num_graphs} graph")
